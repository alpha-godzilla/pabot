...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='dual_velocity', help='chooses which model to use.')
        ...
        parser.add_argument('--controlled_pairing', type=util.str2bool, nargs='?', const=True, default=False,
                            help='enable controlled paired/unpaired mixing in training dataset')
        parser.add_argument('--paired_ratio', type=float, default=0.1,
                            help='front ratio used as paired subset when controlled_pairing is enabled')
        parser.add_argument('--pair_seed', type=int, default=3407,
                            help='random seed for controlled unpaired sampling')
