...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_epoch_freq', type=int, default=10, help='frequency of saving numbered epoch checkpoints (latest is still saved every epoch end)')
        parser.add_argument('--eval_epoch_freq', type=int, default=1, help='frequency of running validation at epoch end')
